(function (e) {
  function t(t) {
    for (
      var n, u, l = t[0], s = t[1], i = t[2], c = 0, v = [];
      c < l.length;
      c++
    )
      (u = l[c]),
        Object.prototype.hasOwnProperty.call(o, u) && o[u] && v.push(o[u][0]),
        (o[u] = 0);
  ...
  '56d7': function (e, t, r) {
    ...
    var n = r('2b0e'),
          ...
          [
            r(
              ...
              [
                ...
                e._v(' | '),
                r('router-link', { attrs: { to: '/notes' } }, [e._v('Notes')]),
              ],
              1
            ),
            r('router-view'),
      ...
      m = d,
      b = (r('4c05'), Object(u['a'])(m, f, h, !1, null, '6b74f606', null)),
      g = b.exports,
      _ = { name: 'Home', components: { HelloWorld: g } },
      j = _,
    ...
    var y = [
        ...
        },
        {
          ...
          name: 'notes',
          component: function () {
            return r.e('about').then(r.bind(null, '0191'));
          },
        },
      ],
      x = new c['a']({ mode: 'history', base: '/', routes: y }),
      O = x,
      E = r('2f62');
    n['default'].use(E['a']);
    var P = new E['a'].Store({
      ...
      C = r('5f5b'),
      $ = (r('f9e3'), r('2dd8'), r('bc3a')),
      S = r.n($),
      H = r('2106'),
      T = r.n(H);
    n['default'].use(C['a']),
      n['default'].use(T.a, S.a),
      (S.a.defaults.baseURL = 'https://covid-app-mevn.herokuapp.com/api'),
...
//# sourceMappingURL=app.10cb9387.js.map
